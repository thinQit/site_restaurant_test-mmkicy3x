...
export default function TestimonialsGrid({
  headline = 'What Our Guests Are Saying',
  subheadline = 'Stories from diners who made Saffron Table part of their celebrations.',
  testimonials = [],
                  ...
                  {t.rating && (
                    <div className="mb-3 flex gap-1">
                      {Array.from({ length: t.rating }).map(function (_, j) {
                        return <span key={j} className="text-[color:var(--accent)]">&#9733;</span>;
                      })}
                    </div>
                  )}
