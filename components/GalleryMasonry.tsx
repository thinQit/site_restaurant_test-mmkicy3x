...
export default function GalleryMasonry({
  headline = 'Gallery',
  subheadline = 'A glimpse into our dishes, ambiance, and evenings at Saffron Table.',
  images = [
    { url: 'https://res.cloudinary.com/dwc294mzm/image/upload/c_fill,w_800,h_800,g_auto/v1/site-images/corporate/default.jpg', alt: 'Restaurant interior with warm lighting', caption: 'Elegant dining room ambiance' },
    { url: 'https://res.cloudinary.com/dwc294mzm/image/upload/c_fill,w_1000,h_750,g_auto/v1/site-images/corporate/default.jpg', alt: 'Chef plating a gourmet dish', caption: 'Chef-crafted seasonal plates' },
    { url: 'https://res.cloudinary.com/dwc294mzm/image/upload/c_fill,w_1200,h_675,g_auto/v1/site-images/corporate/default.jpg', alt: 'Signature plated entrée', caption: 'Our signature main course' },
  ],
